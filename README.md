...
| Локализация                   | [Localizations](https://github.com/IBEC-BOX/admin-kit-Localizations) | Полноценный        | В разработке. Пакет для создания переводов для фронт разработчиков. Доступна мультиязычность.                                                                                                                          | 90% :large_orange_diamond: | :heavy_minus_sign:        |
| Контакты                      | [Contacts]()                                                         | Полноценный        | На стадии идеи. Пакет для создания Контактов. Доступна мультиязычность.                                                                                                                                                | 50% :o:                    | 0% :o:                    |
